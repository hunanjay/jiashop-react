...
export function CustomizerCTA() {
  return (
    <section className="px-8 mb-32">
      <div className="max-w-7xl mx-auto rounded-xl bg-gray-900 overflow-hidden relative">
        <div className="flex flex-col lg:flex-row min-h-[600px]">
          <div className="flex-1 p-16 flex flex-col justify-center text-white space-y-8">
            ...
            <Link to="/catalog" className="w-fit px-10 py-4 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-500 transition-colors shadow-sm">
              进入工作室
            </Link>
          </div>
          <div className="flex-1 bg-gray-800/30 relative overflow-hidden flex items-center justify-center">
            {/* Mockup of the UI */}
            <div className="bg-white/10 border border-white/10 rounded-xl w-4/5 h-4/5 shadow-2xl p-8 flex flex-col gap-6">
                ...
                <div className="w-1/3 space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="h-10 bg-white/20 rounded-lg ring-2 ring-blue-500"></div>
