...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('border-b border-gray-200 bg-gray-50 text-gray-500', className)} {...props} />
))
...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (
  <td ref={ref} className={cn('px-4 py-4 align-middle text-gray-900', className)} {...props} />
))
